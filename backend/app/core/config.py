...
class Settings(BaseSettings):
    ...
    openai_order_response_model: str = "gpt-5.6-sol"
    ...
    change without a code edit. Changed from gpt-5.6-luna to gpt-5.6-sol on
    2026-09-23 (management call); accuracy on real documents still not
    re-verified for this model — see docs/known-issues.md."""
    ...
    openai_price_ingestion_model: str = "gpt-5.6-sol"
    """Provisional default, pending accuracy verification on real supplier
    price lists — see ADR-0019 §3. Changed from gpt-5.6-luna to gpt-5.6-sol
    on 2026-09-23 (management call); accuracy on real documents still not
    re-verified for this model — see docs/known-issues.md."""
