...
from app.models import Category, Material, Price, Supplier, User, UserSession
...
def make_material(db_session, make_category):
    ...
    def _make(sku=None, unit="ft", category=None):
        ...
        material = Material(
            internal_sku=sku, canonical_name=sku, category_id=category.id, unit=unit, attributes={}
        )
